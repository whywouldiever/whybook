<template>
    <view style="height: 100%">
		<view class="top">
			<image class="icon" src="../../static/image/book.png"></image>
			<view class="title">欢迎{{userInfo.nickName}}进入图书借阅柜</view>
		</view>
        <!-- 轮播图 -->
        <swiper class="swiper-container" indicator-dots indicator-color="black" indicator-active-color="white" autoplay interval="2000" circular>
            <!-- 第一个轮播图 -->
            <swiper-item>
                <view class="item">
                    <image src="/static/image/lunbo_book.jpg" class="itemImage"></image>
                </view>
            </swiper-item>
            <!-- 第二个轮播图 -->
            <swiper-item>
                <view class="item">
                    <image src="/static/image/lunbo_book1.jpg" class="itemImage"></image>
                </view>
            </swiper-item>
            <!-- 第三个轮播图 -->
            <swiper-item>
                <view class="item">
                    <image src="/static/image/lunbo_book2.jpg" class="itemImage"></image>
                </view>
            </swiper-item>
        </swiper>
